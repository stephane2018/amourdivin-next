...
import { useGetPopularPostAllTime } from "@/hooks/usePostes";
...
const PopularArticleAllTime = ({ isEnable }: { isEnable: boolean }) => {
  // const {
  //   PosteCurrenyearList,
  //   isLoadingAll: isLoading,
  //   isError,
  // } = useGetPopularPostsForTheCurrentyear(isEnable);
  const { data, isLoading } = useGetPopularPostAllTime();
...
export default PopularArticleAllTime;
